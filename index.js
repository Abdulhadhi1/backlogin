...
const mongoUrl =
"mongodb+srv://abdul123:abdul123@cluster0.xtrfob5.mongodb.net/?retryWrites=true&w=majority";
...
app.post("/forgot-password", async (req, res) => {
    ...
    //   const oldUser = await User.findOne({ email });
      ...
      var transporter = nodemailer.createTransport({
        service: "gmail",
        auth: {
          user: "hadhi3336@gmail.com",
          pass: "dydzovqffcvhzlze"
        }
      });

      var mailOptions = {
        from: "hadhi3336@gmail.com",
        to: req.body.email,
